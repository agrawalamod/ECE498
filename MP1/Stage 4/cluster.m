...
%{
idling_data = readtable('./Data/Data2/IDLE_02-51-19_08:51:13_0cm.csv');

jumping_data = readtable('./Data/Data2/JUMPING_02-57-19_08:57:55_0cm.csv');

running_data = readtable('./Data/Data2/RUNNING_02-02-19_09:02:19_1000cm.csv');

stairs_data = readtable('./Data/Data2/STAIRS_02-03-19_09:03:31_1000cm.csv');

walking_data = readtable('./Data/Data2/WALKING_02-50-19_095040_600cm.csv');
%}


idling_data = readtable('./Data/Data1/IDLING_10-17-18_10:17:16_0cm.csv');

jumping_data = readtable('./Data/Data1/JUMPING_10-15-18_10:15:43_0cm.csv');

running_data = readtable('./Data/Data1/RUNNING_10-15-18_10:15:07_1000cm.csv');

stairs_data = readtable('./Data/Data1/STAIRS_10-16-18_10:16:45_200cm.csv');

walking_data = readtable('./Data/Data1/WALKING_10-13-18_10:13:48_1000cm.csv');
